...
function Experience() {
  return (
    <section id="experience" className="section-shell content-section">
      <SectionHeading number="02" eyebrow="Experience" title="Built in environments where the details matter." copy="A path through large-scale systems, healthcare products, data engineering, and education." />
...
function Projects() {
  return (
    <section id="projects" className="section-shell content-section">
      <SectionHeading number="03" eyebrow="Selected work" title="From idea to shipped product." copy="A featured independent build, plus a glimpse at the kinds of systems I’ve worked on professionally." />
...
function Skills() {
  return (
    <section id="skills" className="section-shell content-section">
      <SectionHeading number="04" eyebrow="Skills" title="A toolkit for building the whole thing." />
